<?php 
$json_string = file_get_contents("http://api.wunderground.com/api/39e449f654a8416d/conditions/q/Mugassari.json"); 
...
echo "<br>";
echo "Suhu Udara : ${feelslike_c} derajat celcius.  \n";
echo " (Gunakan Pakaian berbahan tipis.) <br>";
